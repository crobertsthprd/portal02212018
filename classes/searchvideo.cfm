...
<CFLOCATION url="/portal/searchvideo.cfm">
<CFABORT>

<CFPARAM name="url.id" default="1">
<CFSWITCH expression="#url.id#">
	<CFCASE value="1"><CFSET linkfile = "iA5cnZNxxzM"><CFSET pagetitle="Online Registration: Log-In"></CFCASE>
