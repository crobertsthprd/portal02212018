<cfquery name="GetClassData" datasource="#application.reg_dsn#">
...
<cfelse>
 	<cfquery datasource="#application.reg_dsn#" name="GetReqAssmt1">
      select *
	  ...
	  <cfquery datasource="#application.reg_dsn#" name="GetReqAssmt2">
      select *
      from assessmentrates
	 ...
	 <CFELSE>
		...
		<CFQUERY name="GetReqAssmt3" datasource="#application.reg_dsn#">
	 ...
	 <!--- get annuals --->
	  <cfquery datasource="#application.reg_dsn#" name="GetReqAssmtAnnuals">
      select *
      from assessmentrates
      where #CreateODBCDate(GetClassData.startdt)# between assmteffective - grace::integer and assmtexpires + grace::integer
