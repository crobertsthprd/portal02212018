...
<p>Please contact THPRD for assistance 503-439-9400. Your class enrollments are reserved.</p>
</CFSAVECONTENT>
		...
		<cfif form.tenderedcharge gt 0>
			<CFIF viaWarp EQ true>
					...
					<cfif variables.sessionwasfinished neq 0>
                              ...
                              <cftransaction action="rollback" />
                              <CFMAIL to="webadmin@thprd.org" cc="dhayes@thprd.org" from="webadmin@thprd.org" subject="DEV Possible Session Error - Class Check Out">
			...
			<cfelse>
				...
				<cfif variables.sessionwasfinished neq 0>
					<!--- open call was created. rollback and stop user form further actions. --->
					<cftransaction action="rollback" />
                         <CFMAIL to="webadmin@thprd.org" cc="dhayes@thprd.org" from="webadmin@thprd.ogr" subject="Possible Session Error - Class Check Out" type="html">
