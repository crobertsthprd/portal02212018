...
<cfif 1 EQ 1>
	...
	<cfdump var="#GetPatrons#" label="_getpatrons">
</cfif>
...
<cfif form.processaction NEQ "ProceedToProcess" or 1>
	...
	<cfoutput><br>#GetPatrons.secondarypatronid#<br></cfoutput>
		<cfset FinalArray[currentrow][1] = 0><!--- patronid --->
		<cfset ShirtArray2 = ListToArray(ShirtArray[currentrow], "^")>
		<cfset SchoolArray2 = ListToArray(SchoolArray[currentrow], "^")>
		<cfset AppArray2 = ListToArray(AppArray[currentrow], "^")>
		<cfset FinalArray[currentrow][1] = ShirtArray2[1]><!--- patronid --->
		<cfset FinalArray[currentrow][2] = ShirtArray2[2]><!--- shirt size --->
		<cfset FinalArray[currentrow][3] = SchoolArray2[2]><!--- school pathing code --->
		<cfset FinalArray[currentrow][4] = AppArray2[2]><!--- activity code --->



		<CFIF AppArray2[3] EQ 0>
          <cfset FinalArray[currentrow][2] = "NA">
          </CFIF>
