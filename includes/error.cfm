<CFIF cgi.remote_addr NEQ application.webmasterIP AND cgi.remote_addr is not "192.168.160.92" >
<CFCONTENT reset="yes">
<html>
<head>
...
<cfmail to="webadmin@thprd.org,dhayes@thprd.org" from="webadmin@thprd.org" subject="Secure Portal: Application Error" type="html">
...
Erroring Page<br>
-------------<br>
#cgi.script_name#<br><br>

Date of Error<br>
-------------<br>
#dateformat(now(),'mm/dd/yyyy')# - #timeformat(now(),'hh:mm tt')#<br><br>

Error Details<br>
-------------<br>
User IP: #cgi.REMOTE_ADDR#<br>
