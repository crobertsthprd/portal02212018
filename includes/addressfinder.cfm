<cffunction name="GetAddressID" output="Yes" returntype="numeric">
 ...
 <cfquery datasource="#application.dopsds#" name="_FindAddressID">
  select  AddressID
 ...
 <cfif _FindAddressID.recordcount is 0>
  ...
  <cfquery datasource="#application.dopsds#" name="_GetNewAddressID">
   Select   addressid
   from     patronaddresses
  ...
  <cfquery datasource="#application.dopsds#" name="_MakeNewAddressRow">
